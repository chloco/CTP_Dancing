...
public class AudioSyncer : MonoBehaviour
{
    ...
    public float timeStep;//the minimum interval between each beat
    public float timeToBeat;//how much time before the visualisation completes
    public float restSmoothTime;//how fast the object goes to rest after beat 

    private float m_previousAudioValue;//determine if the value went above or below the bias,triggering a beat
